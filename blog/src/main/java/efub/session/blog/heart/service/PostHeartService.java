...
public class PostHeartService {
    ...
    public void create(Long postId, Long accountId) {
        ...
        if (isExistsByAccountAndPost(account, post)) {
    ...
    public void delete(Long postId, Long accountId) {
        ...
        // 작성자와 게시글이 존재하는지 확인
        PostHeart postHeart = postHeartRepository.findByAccountAndPost(account, post)
    ...
    public Boolean isHeart(Long accountId, Post post){
        ...
        return isExistsByAccountAndPost(account, post);
    }

    @Transactional(readOnly = true)
    public Boolean isExistsByAccountAndPost(Account account, Post post) {
        return postHeartRepository.existsByAccountAndPost(account, post);
    }
